...
exports.projectWithUserLayout = exports.projectWithCustomBlock = exports.initialProject = exports.projectWithDatalogging = exports.projectWithMelody = exports.strawbeesExample = exports.projectWithTwoExtensions = exports.projectWithExtensionBlock = exports.projectWithLayout = exports.project = void 0;
exports.project = {
    text: {
...
exports.projectWithExtensionBlock = {
    text: {
        'README.md': '',
...
exports.projectWithTwoExtensions = {
    text: {
        'README.md': '',
...
exports.projectWithDatalogging = {
    text: {
...
exports.projectWithCustomBlock = {
    text: {
        'README.md': '',
        'custom.ts': '//% color="#8888FF"\nnamespace something {\n    //% block\n    export function myCustomFunction(): void {\n        basic.showString("hello")\n    }\n}',
        'main.blocks': '<xml xmlns="https://developers.google.com/blockly/xml"><block type="pxt-on-start" x="0" y="0"><statement name="HANDLER"><block type="something_myCustomFunction"></block></statement></block></xml>',
